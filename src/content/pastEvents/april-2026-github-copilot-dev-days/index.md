...
speakerResources:
  - speakerName: "Augustine Correa"
    ...
    resourceUrl: "/blog/from-vibes-to-verification-spec-driven-development"
    resourceType: "blog"
    description: "Deep dive into Spec-Driven Development, OpenSpec, and Context Engineering for keeping AI aligned with human intent"
  - speakerName: "Maninderjit (Mani) Bindra"
    resourceTitle: "GitHub Copilot Model Context Protocol (MCP) - Vulnerabilities and Controls"
    resourceUrl: "./resources/ghcp-dev-days- mcp-vulnerabilities-and-controls-1.1.pdf"
