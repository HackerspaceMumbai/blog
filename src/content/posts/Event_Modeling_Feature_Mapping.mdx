...
<Image src={import('../../assets/images/Impact_Mapping_Revised.png')} alt="Impact Mapping Revised" />
...
<Image src={import('../../assets/images/Azure_DevOps_Epics.png')} alt="Azure DevOps Epics" />
...
<Image src={import('../../assets/images/Azure_DevOps_Features.png')} alt="Azure DevOps Features" />
...
<Image src={import('../../assets/images/Feature_Mapping_Shortlisting.png')} alt="Feature Mapping for Shortlisting" />
...
<Image src={import('../../assets/images/azure_devops_user-story.png')} alt="Azure DevOps User Story" />

<Image src={import('../../assets/images/azure_devops_user_stories.png')} alt="Azure DevOps Feature Hierarchy" />
