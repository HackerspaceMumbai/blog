...
description: "From 7x over-subscription to fairness-aware decision systems-how we built an AI-assisted, privacy-first curation platform using Azure AI Foundry and thoughtful UX design."
date: 2026-06-03
...
import Onboarding_Step1 from './onboarding_step1.png'
...
import FairnessChipAfterSellection from './fairness_chips_after_selection.png'
...
<Image src={Onboarding_Step1} alt="Registration form" />
...
<Image src={SocialNetworkVerification} alt="A registration form with Linked and GitHub connect button" />
...
📷 <Image src={FairnessChipAfterSellection} alt="Screenshot of Curation with the Gender and Langauage highlighted within the red box" />
...
📷 <Image src={ProfilePanelAssessment} alt="Profile Panel Assessment along wiith Fainness delta" />
