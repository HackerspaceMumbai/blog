...
<Image src={import('../../assets/images/Visage_FreeForm_WireFraming.jpg')} alt="Drawing of the Visage Session page wireframe in a book" />
...
<Image src={import('../../assets/images/Visage_WireFraming_EventSession.png')} alt="Microsoft Whiteboard sketch of Visage's Event Details page" />
...
<Image src={import('../../assets/images/Visage_Figma_Draft.png')} alt="Figma first draft using Layout Grid with SVG wireframe to the left" />
...
<Image src={import('../../assets/images/Visage_Figma_Frames.png')} alt="Visage's Final three Figma Frames for each of the pages. A tab, within the Figma App toolbar, of a community toolkit is circled in green" />
...
<Image src={import('../../assets/images/Visage_Figma_Prototype.gif')} alt="Prototype of Visage App" />
...
<Image src={import('../../assets/images/Figma_Design_Components.png')} alt="Figma_AssetPanel_Components" />
