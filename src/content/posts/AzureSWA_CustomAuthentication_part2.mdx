...
<Image src={import('../../assets/images/auth0_application_properties.png')} alt="The Auth0 Application Details page with the Client ID and Client Secret information redacted" />
...
<Image src={import('../../assets/images/auth0_oauth_application_url.png')} alt="Auth0 Application Details page with the Application URIs " />
...
1. Visit the Hosting Plan tab under the Static Web App in the Azure Portal to convert the plan from Free to Standard.
   <Image src={import('../../assets/images/azure__portal_hosting_plan.png')} alt="Hosting Plan tab on the Azure SWA " />
...
2. Click on the Configuration link within the navigation pane, choose the stage environment and add two application secrets, namely AUTH0_CLIENT_ID, & AUTH0_CLIENT_SECRET, with the values from step 1 of the Auth0 subsection above.
   <Image src={import('../../assets/images/azureswa_application_secrets_portal.png')} alt="Configuration settings on the Azure SWA blade of the Azure Portal" />
...
<Image src={import('../../assets/images/swacli_emulator_customauth.png')} alt="Azure SWA emulator with the provider and username inputs highlighted in red" />
...
<Image src={import('../../assets/images/weatherforecast_customauthn.png')} alt="Blazor WASM default page" />
...
<Image src={import('../../assets/images/weatherforecast_customauthz_fail.png')} alt="Weather Forecast Fetch data page with Not Authorized highlighted on the page" />

### Auth0 Role Management

1. On the Auth0 end, we create a Role named "weathercaster".
    <Image src={import('../../assets/images/auth0_add_role.png')} alt="Auth0 role management" />

2. Add my username to the role.
   <Image src={import('../../assets/images/auth0_add_user_role.png')} alt="Auth0 Adding a user to the role" />
...
<Image src={import('../../assets/images/Auth0_custom_action.png')} alt="Auth0 Page with a button named Build Custom alongside another button to Add Action below them a table of existing actions" />

2. Create a custom Action.

<Image src={import('../../assets/images/auth0_add_action.png')} alt="A modal Auth0 Action Create with 3 input elements" />
...
<Image src={import('../../assets/images/auth0_custom_action_code.png')} alt="A Monaco code editor is pre-filled with code snippet to add roles to the ID Token and the Access token " />

4. We need to add the roles during our Login Flow.

<Image src={import('../../assets/images/auth0_choose_flow.png')} alt="The Flow Page under the Action Tab is highlighted. The different available flows are listed in a card format" />

5. Drag and drop our Custom Action into the Login Flow.

<Image src={import('../../assets/images/auth0_flow_add_action.png')} alt="A visual canvas with a Start and Complete blobs are present. And the space in between them is highlighted in red by the author" />

6. Apply the changes, and we are done on the Auth0 end.

<Image src={import('../../assets/images/auth0_flow_apply_action.png')} alt="The Add Visage Role Custom Action is placed between the Start and Complete icons in the canvas. The Apply button has a author-drawn green arrow pointed towards it" />
...
<Image src={import('../../assets/images/auth0_sample_app_profile.png')} alt="The Auth0 sample app page displaying the payload sent over by Auth0 post login" />
...
<Image src={import('../../assets/images/vscode_AzureSWA_AzureFunction.png')} alt="VS Code with highlights of the Command Palette, SWA config file in the code editor tab and thenewly created folder and files under the File Explorer" />
...
<Image src={import('../../assets/images/azurefunction_api_role_mgmt.png')} alt="VS Code with the left tab showing the test payload, the right tab displaying the result returned from the Azure Function,and the bottom console displaying the log stream generated by the invoked Azure Function" />
...
<Image src={import('../../assets/images/azureswa_appl_insight.png')} alt="Application Insight tab is highlighted within the Azure Static Web App blade on the Azure Portal" />
...
<Image src={import('../../assets/images/weatherforecast_customauthz_success.png')} alt="Weather forecast with Auth0 provided login show and side-by-side browser developer console is shown" />
...
<Image src={import('../../assets/images/vscode_AzureSWA_extension.png')} alt="The Azure VS Code extension is expanded out and its various resources are visible" />

But in the quickstart for step 2 [which was removed last month after the team was informed] is shown as below:

<Image src={import('../../assets/images/vscode_AzureSWA_extension_initial.png')} alt="VS Code extension for Azure Static Web Apps with a plus icon boxed in red highlight and an adjacent lightning icon fenced in green highlight" />
...
<Image src={import('../../assets/images/vscode_AzureSWA_marketplace.png')} alt="Text highlighted in red" />
...
<Image src={import('../../assets/images/msdocs_azureswa_api_constraints.png')} alt="Text about API route nomenclature highlighted in red" />

But, the VS Code extension generated Github Action workflow file names it as "Api".

<Image src={import('../../assets/images/vscode_extension_github_action.png')} alt="GitHub Action workflow YAML" />

Innocuous, right? Read on.

When we create the API via the command palette as instructed by the MS Docs,

<Image src={import('../../assets/images/vscode_extension_command_pallette_create_api.png')} alt="VS Code extension command palette expanded with the Create API command in the middle of the list" />

it creates a file folder titled "api" in the SWA folder.

<Image src={import('../../assets/images/vscode_api_file_explorer.png')} alt="VS Code File Folder side tab with api folder highlighted in red" />

Now,if you test it locally via the SWA CLI using "API"on windows ,it works !!!

<Image src={import('../../assets/images/swa_cli_api_option_windows.png')} alt="SWA CLI" />

And when pushed to GitHub, no error is thrown and is deployed. But errors out on the browser.

<Image src={import('../../assets/images/weatherforecast_api_nomenclature_fail.png')} alt="Weather browser opened in browser with the developer tool console opened side by side and riddled with http error code" />

If you are diligent enough to go through the successful GitHub Actions logs, there is a hint.

<Image src={import('../../assets/images/github_action_log_azureswa_api_warning.png')} alt="GitHub Actions logs with a missing API warning" />
