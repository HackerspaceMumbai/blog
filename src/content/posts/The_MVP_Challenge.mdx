...
<Image src={import('../../assets/images/Gladiator.jpg')} alt="Quote by Maximus from the movie Gladiator - Imagine where you will be and it will be so" />
...
<Image src={import('../../assets/images/HM-MicrosoftSecurityScore.png')} alt="Hackerspace Mumbai's M365 Microsoft Secure Score" />
...
<Image src={import('../../assets/images/HM-Sharepoint.png')} alt="Hackerspace Mumbai Sharepoint" />
...
<Image src={import('../../assets/images/MSEdge_Sharepoint.png')} alt="Search Sharepoint date on Microsoft Edge" />
...
<Image src={import('../../assets/images/Spidey.gif')} alt="Uncle Ben famous quote in Spiderman: With Great Power Comes Great responsibility" />
...
<Image src={import('../../assets/images/Build_2021_Teams.png')} alt="Wearing an MS Office T-shirt and taking part in a Microsoft Build 2021 session that we recorded in MS Teams" />
...
<Image src={import('../../assets/images/HM_Screening_Process.png')} alt="Hackerspace Mumbai screening question" />
...
Some stretch features that this learning path has got us thinking:
  ...
  <Image src={import('../../assets/images/MicrosoftVisionAIKit.jpg')} alt="Microsoft Vision AI kit" />
...
<Image src={import('../../assets/images/AbilitySummit21.png')} alt="Ability Summit" />
