...
import ImpactMappingRevised from './Impact_Mapping_Revised.png';
import AzureDevOpsEpics from './Azure_DevOps_Epics.png';
import AzureDevOpsFeatures from './Azure_DevOps_Features.png';
import FeatureMappingShortlisting from './Feature_Mapping_Shortlisting.png';
import AzureDevopsUserStory from './azure_devops_user-story.png';
import AzureDevopsUserStories from './azure_devops_user_stories.png';
...
<Image src={ImpactMappingRevised} alt="Impact Mapping Revised" />
...
<Image src={AzureDevOpsEpics} alt="Azure DevOps Epics" />
...
<Image src={AzureDevOpsFeatures} alt="Azure DevOps Features" />
...
<Image src={FeatureMappingShortlisting} alt="Feature Mapping for Shortlisting" />
...
<Image src={AzureDevopsUserStory} alt="Azure DevOps User Story" />

<Image src={AzureDevopsUserStories} alt="Azure DevOps Feature Hierarchy" />
