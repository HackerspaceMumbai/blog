...
# If it needs optimization, it should be handled via the schema: image() helper.
cover: ./cover.png
...
import VisageFreeFormWireFraming from './Visage_FreeForm_WireFraming.jpg';
import VisageWireFramingEventSession from './Visage_WireFraming_EventSession.png';
import VisageFigmaDraft from './Visage_Figma_Draft.png';
import VisageFigmaFrames from './Visage_Figma_Frames.png';
import VisageFigmaPrototype from './Visage_Figma_Prototype.gif';
import FigmaDesignComponents from './Figma_Design_Components.png';
...
<Image src={VisageFreeFormWireFraming} alt="Drawing of the Visage Session page wireframe in a book" />
...
<Image src={VisageWireFramingEventSession} alt="Microsoft Whiteboard sketch of Visage's Event Details page" />
...
<Image src={VisageFigmaDraft} alt="Figma first draft using Layout Grid with SVG wireframe to the left" />
...
<Image src={VisageFigmaFrames} alt="Visage's Final three Figma Frames for each of the pages. A tab, within the Figma App toolbar, of a community toolkit is circled in green" />
...
<Image src={VisageFigmaPrototype} alt="Prototype of Visage App" />
...
<Image src={FigmaDesignComponents} alt="Figma_AssetPanel_Components" />
