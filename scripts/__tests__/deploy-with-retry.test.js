...
describe('deploy-with-retry', () => {
  ...
  beforeEach(() => {
    ...
    // Mock setTimeout to speed up retry tests
  ...
  describe('environment validation', () => {
    it('should require NETLIFY_AUTH_TOKEN', () => {
      ...
      // This would be tested in integration tests since main() is not easily unit testable
  ...
  describe('structured logging', () => {
    it('should log with timestamps and sanitization', () => {
      ...
      // Import and call a function that logs
      sanitizeErrorMessage('test message');
      
      // The actual logging happens in the main functions, so we verify the spy was set up
